...
export default class Parametros extends Model<ParametroInterface,ParametroCreationAttributes> implements ParametroInterface{
    public fuerzaRozamiento!:number;
    public coeficienteRozamiento!:number;
