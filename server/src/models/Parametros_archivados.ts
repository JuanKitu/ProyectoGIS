...
export default class Parametros_Archivados extends Model<ParametroInterface,ParametroCreationAttributes>{};
...
Parametros_Archivados.init({
    ...
    sequelize,
    modelName: 'Parametros_Archivados', //nombre que tiene en la tabla de la DB
    timestamps: false,
