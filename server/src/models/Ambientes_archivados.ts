...
export default class Ambientes_Archivados extends Model<AmbienteInterface,AmbienteCreationAttributes>{};

Ambientes_Archivados.init({
    temperatura: {
        type: DataTypes.REAL,
        allowNull: false
    },
    ...
    sequelize,
    modelName: 'Ambientes_Archivados', //nombre que tiene en la tabla de la DB
    timestamps: false,
